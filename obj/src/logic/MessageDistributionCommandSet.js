...
class MessageDistributionCommandSet extends pip_services_commons_node_2.CommandSet {
    ...
    makeSendMessageCommand() {
        return new pip_services_commons_node_3.Command("send_message", new pip_services_commons_node_4.ObjectSchema(true)
    ...
    makeSendMessagesCommand() {
        return new pip_services_commons_node_3.Command("send_messages", new pip_services_commons_node_4.ObjectSchema(true)
            .withRequiredProperty('message', new MessageV1Schema_1.MessageV1Schema())
            .withRequiredProperty('recipients', new pip_services_commons_node_5.ArraySchema(new RecipientV1Schema_1.RecipientV1Schema()))
            .withOptionalProperty('parameters', pip_services_commons_node_6.TypeCode.Map)
            .withOptionalProperty('method', pip_services_commons_node_6.TypeCode.String), (correlationId, args, callback) => {
            let message = args.get("message");
