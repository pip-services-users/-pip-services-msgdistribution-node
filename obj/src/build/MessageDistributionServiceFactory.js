...
class MessageDistributionServiceFactory extends pip_services_commons_node_1.Factory {
    constructor() {
        super();
...
MessageDistributionServiceFactory.Descriptor = new pip_services_commons_node_2.Descriptor("pip-services-msgdistribution", "factory", "default", "default", "1.0");
MessageDistributionServiceFactory.ControllerDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-msgdistribution", "controller", "default", "*", "1.0");
MessageDistributionServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-msgdistribution", "service", "seneca", "*", "1.0");
MessageDistributionServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-msgdistribution", "service", "http", "*", "1.0");
