...
var plugin = require('pip-services-msgdistribution-node').MessageDistributionSenecaPlugin;
...
or by using [MessageDistributionSenecaClient](https://github.com/pip-services-users/pip-clients-msgdistribution-node/NodeClientApiV1.md/#client_seneca)